...
private enum MIRALocalizationTable {
  private static let values: [String: [String: String]] = [
    "en": [
      ...
      "auth.username_subtitle": "This is how people will find you on Aura.",
      ...
      "welcome.capture.title": "SCAN\nREAL\nPROOF",
      "welcome.capture.subtitle": "Scan receipts and invoices without publishing your private documents.",
      "welcome.discover.title": "BUILD\nTRUST\nFROM FACTS",
      "welcome.discover.subtitle": "Verified events can support honest business, product, and user reputation.",
      "welcome.people.title": "OWN\nYOUR\nVALUE",
      "welcome.people.subtitle": "Keep your Aura wallet local and see only real proofs, balances, and confirmations.",
      "feed.title": "Home",
      ...
      "discover.category.places": "Places",
      ...
      "report.submitted.body": "Thanks for helping keep Aura safe. We’ll review this and take action if it breaks our rules.",
      ...
      "report.reason.minor_safety": "Child safety concern",
      ...
      "settings.language_updated": "Language updated. Restart Aura to apply language change everywhere.",
      ...
      "settings.restart_to_apply": "Restart Aura to apply language change.",
    ...
    "fr": [
      ...
      "auth.username_subtitle": "C’est ainsi que les gens vous trouveront sur Aura.",
      ...
      "welcome.capture.title": "NUMÉRISEZ\nDES PREUVES\nRÉELLES",
      "welcome.capture.subtitle": "Numérisez reçus et factures sans publier vos documents privés.",
      "welcome.discover.title": "BÂTISSEZ\nLA CONFIANCE\nSUR DES FAITS",
      "welcome.discover.subtitle": "Des événements vérifiés peuvent soutenir une réputation honnête.",
      "welcome.people.title": "GARDEZ\nVOTRE\nVALEUR",
      "welcome.people.subtitle": "Gardez votre portefeuille Aura local et consultez uniquement des données réelles.",
      "feed.title": "Accueil",
      ...
      "discover.category.places": "Lieux",
      ...
      "report.submitted.body": "Merci d’aider à garder Aura sûr. Nous examinerons ce contenu et agirons s’il enfreint nos règles.",
      ...
      "report.reason.sexual_content": "Nudité ou contenu sexuel",
      "report.reason.sexual_exploitation": "Contenu sexuel ou exploitation",
      "report.reason.minor_safety": "Préoccupation liée à la sécurité des enfants",
      ...
      "settings.language_updated": "Langue mise à jour. Redémarrez Aura pour l’appliquer partout.",
      ...
      "settings.restart_to_apply": "Redémarrez Aura pour appliquer la langue.",
    ...
    "es": [
      ...
      "auth.username_subtitle": "Así es como la gente te encontrará en Aura.",
      ...
      "welcome.capture.title": "ESCANEA\nPRUEBAS\nREALES",
      "welcome.capture.subtitle": "Escanea recibos y facturas sin publicar tus documentos privados.",
      "welcome.discover.title": "CREA\nCONFIANZA\nCON HECHOS",
      "welcome.discover.subtitle": "Los eventos verificados pueden respaldar una reputación honesta.",
      "welcome.people.title": "CONSERVA\nTU\nVALOR",
      "welcome.people.subtitle": "Mantén tu billetera Aura local y consulta únicamente datos reales.",
      "feed.title": "Inicio",
      ...
      "discover.category.places": "Lugares",
      ...
      "report.submitted.body": "Gracias por ayudar a mantener Aura seguro. Revisaremos esto y tomaremos medidas si rompe nuestras reglas.",
      ...
      "report.reason.sexual_content": "Desnudez o contenido sexual",
      "report.reason.sexual_exploitation": "Contenido sexual o explotación",
      "report.reason.minor_safety": "Preocupación por seguridad infantil",
      ...
      "settings.language_updated": "Idioma actualizado. Reinicia Aura para aplicarlo en todas partes.",
      ...
      "settings.restart_to_apply": "Reinicia Aura para aplicar el idioma.",
