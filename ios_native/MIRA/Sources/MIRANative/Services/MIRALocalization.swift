...
private enum MIRALocalizationTable {
  private static let values: [String: [String: String]] = [
    "en": [
      ...
      "welcome.capture.subtitle": "Share photos and short videos that feel real.",
      "welcome.discover.title": "DISCOVER\nYOUR\nWORLD",
      "welcome.discover.subtitle": "Explore style, places, stories, and moments that feel real and related.",
    ...
    "fr": [
      ...
      "welcome.capture.subtitle": "Partagez des photos et de courtes vidéos qui semblent vraies.",
      "welcome.discover.title": "DÉCOUVREZ\nVOTRE\nMONDE",
      "welcome.discover.subtitle": "Explorez le style, les lieux, les histoires et les moments qui vous ressemblent.",
    ...
    "es": [
      ...
      "welcome.capture.subtitle": "Comparte fotos y videos cortos que se sientan reales.",
      "welcome.discover.title": "DESCUBRE\nTU\nMUNDO",
      "welcome.discover.subtitle": "Explora estilo, lugares, historias y momentos que se sienten reales.",
