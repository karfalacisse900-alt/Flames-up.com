...
public enum MIRATheme {
  public enum Color {
    ...
    public static let mediaPlaceholder = SwiftUI.Color(red: 0.640, green: 0.690, blue: 0.620)
    public static let mediaPlaceholderRaised = SwiftUI.Color(red: 0.760, green: 0.805, blue: 0.730)
