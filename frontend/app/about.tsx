...
const s = StyleSheet.create({
  ...
  appName: { fontSize: 24, fontWeight: '600', color: colors.textPrimary, fontStyle: 'italic' },
  ...
  heading: { fontSize: 17, fontWeight: '500', color: colors.textPrimary, marginBottom: 10 },
