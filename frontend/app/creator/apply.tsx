...
const s = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 12, fontWeight: '600', color: colors.textHint, letterSpacing: 0.5, marginBottom: 10, marginTop: 16 },
  ...
  statusTitle: { fontSize: 20, fontWeight: '600', color: colors.textPrimary, marginTop: 16 },
