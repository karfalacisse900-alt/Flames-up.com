...
const s = StyleSheet.create({
  ...
  heroTitle: { fontSize: 20, fontWeight: '600', color: '#991B1B' },
  ...
  cardTitle: { fontSize: 16, fontWeight: '500', color: colors.textPrimary, marginBottom: 12 },
  ...
  emailLink: { fontSize: 16, fontWeight: '500', color: colors.accentPrimary, marginTop: 4 },
  ...
  deleteBtnText: { fontSize: 16, fontWeight: '500', color: '#FFFFFF' },
});
