...
const s = StyleSheet.create({
  ...
  appTitle: { fontSize: 20, fontWeight: '600', color: colors.textPrimary, marginBottom: 4 },
  ...
  sectionTitle: { fontSize: 16, fontWeight: '500', color: colors.textPrimary, marginBottom: 8 },
