...
const s = StyleSheet.create({
  ...
  heroTitle: { fontSize: 20, fontWeight: '600', color: colors.textPrimary, marginBottom: 4 },
  heroBody: { fontSize: 15, color: colors.textSecondary },
  sectionLabel: { fontSize: 12, fontWeight: '600', color: colors.textHint, letterSpacing: 0.5, marginBottom: 10, marginTop: 8 },
  ...
  reportEmail: { fontSize: 16, fontWeight: '500', color: colors.accentPrimary, paddingHorizontal: 16, paddingTop: 4 },
