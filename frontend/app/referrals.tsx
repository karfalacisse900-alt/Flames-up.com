...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 24, fontWeight: '600', color: colors.textPrimary, fontStyle: 'italic' },
  ...
  code: { fontSize: 28, fontWeight: '500', color: colors.accentPrimary, letterSpacing: 3, marginTop: 8 },
  shareBtn: {
  ...
  shareBtnText: { fontSize: 16, fontWeight: '500', color: '#FFFFFF' },
  ...
  statNum: { fontSize: 24, fontWeight: '600', color: colors.textPrimary },
