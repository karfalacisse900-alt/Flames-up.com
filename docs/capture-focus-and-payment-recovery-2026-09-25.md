...
Active app: Captro, bundle com.captro.app, native SwiftUI, iOS 17+. Branch: feature/recorded-voice-moderation. App source commit: 5c13aa7f. Build: 1.0.1 (482.1).
...
- Apple's API confirmed prior build 479.1 is VALID and IN_BETA_TESTING in Captro private and Captro private2. New build status must be verified after upload.
...
Build 482.1 is the intended release for this change. Consult the verified final delivery status rather than assuming dispatch means upload or tester availability.
